            ...
            >
                <div className="p-8">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">Create Account</h2>
                        <p className="text-gray-500 mt-2">Start managing your relocations effortlessly</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-2 group shadow-lg shadow-pink-500/30 mt-2"
                        >
                            Sign Up
                    ...
                    <div className="mt-6 text-center text-sm text-gray-500">
                        ...
                        <Link to="/login" className="text-pink-600 font-semibold hover:text-pink-700 hover:underline">
                            Sign in
                        </Link>
                    </div>
                </div>
